...
def get_decoded_policy_path(exp_name, n=None):
    if n is not None:
        return get_experiment_dir(exp_name) / f"decoded_policy_{n}.pt"
    return get_experiment_dir(exp_name) / "decoded_policy_*.pt"